...
func _build_ui() -> void:
	...
	for it in [["hero", "nav.heroes", "heroes"], ["tower", "nav.tower_tree", "tower_tree"], ["crown", "nav.hero_tree", "hero_tree"], ["missions", "nav.missions", "missions"], ["shop", "nav.shop", "shop"], ["crossed", "nav.arsenal", "inventory"], ["trophy", "nav.achievements", "achievements"], ["guild", "nav.guild", "guild"], ["more", "nav.more", "settings"]]:
